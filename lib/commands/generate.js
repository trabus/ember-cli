...
module.exports = Command.extend({
  ...
  run: function(commandOptions, rawArgs) {
    ...
    this.availableOptions = union(this.availableOptions, task.lookupBlueprint(blueprintName).availableOptions);
    console.log('gen:',this.availableOptions);
    this.registerOptions();
    var updatedCommandOptions = this.parseArgs(this.commandArgs);
    var taskArgs = {
      args: rawArgs
    };
//console.log('args:',this.parseArgs(commandOptions), rawArgs)
    var taskOptions = merge(taskArgs, updatedCommandOptions || {});
