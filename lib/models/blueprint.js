...
/*
  Returns fileMapTokens, can be used as a hook to override.
...
/*
  Returns fileMapTokenValues, can be used as a hook for adding
  token values. The fileMapTokenValues order should match fileMapTokens
